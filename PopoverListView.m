...
- (void)initTheInterface
{
    ...
    self.mainPopoverListView.layer.cornerRadius = 5.0f;
...
- (void)refreshTheUserInterface
{
    ...
    {
        self.doneButton.frame = CGRectMake(0, self.bounds.size.height - ZSYCustomButtonHeight-15.0f, self.bounds.size.width, ZSYCustomButtonHeight);
    }
...
- (void)setCancelButtonTitle:(NSString *)aTitle block:(PZPopoverListViewButtonBlock)block
{
    if (nil == _cancelButton)
    {
        ...
        [self.cancelButton setBackgroundImage:[PopoverListView cancelButtonBackgroundImage] forState:UIControlStateNormal];
...
- (void)setDoneButtonWithTitle:(NSString *)aTitle block:(PZPopoverListViewButtonBlock)block
{
    if (nil == _doneButton)
    {
        ...
        [self.doneButton setBackgroundImage:[UIImage imageNamed:@"bg_filter_popout"] forState:UIControlStateNormal];
...
- (void)buttonWasPressed:(id)sender
{
    ...
    PZPopoverListViewButtonBlock __block block;
